...
namespace Player
{
	...
	Point2 GetShipRowCol();
	void SetShipRowCol(const Point2& position);

	Point2 GetAirshipRowCol();
	void SetAirshipRowCol(const Point2& position);

	Point2 GetPlayerPos();
	void SetPlayerPos(const Point2& position);
